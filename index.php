...
final class Application extends TWXApplication {
    ...
    // The default page which is shown when no action is specified
	 ...
	 private $defaultToken = 'noentitlementzuuutsi';
    ...
    public function actionSignin() {
        ...
        //$username = $_GET['redeemc');
        $username = TWXParam::any('redeemc');
    ...
    public function actionEntitlements() {
        ...
        if (empty($token) or $token == $this->defaultToken) {
			//$token == $this->defaultToken;
            $this->outputJson([
                'entitled_products' => ['com.konterbont.magazine.konterbont_00_2017'],
